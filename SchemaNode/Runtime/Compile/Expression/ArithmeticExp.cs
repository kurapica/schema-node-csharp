...
/// </summary>
public record ArithmeticExp(ArithmeticType Type, SchemaExp[] Args, AnySchemaType SchemaType) : SchemaExp(SchemaType);

/// <summary>
/// The transform arithmetic expression
/// </summary>
public record TransformArithmeticExp(MethodInfo Method, SchemaExp[] Args, AnySchemaType SchemaType) 
    : ArithmeticExp(ArithmeticType.Transform, Args, SchemaType);
    ...
    public Task<SchemaExp?> VisitExpAsync(CompileContext context, SchemaExp exp)
    {
        ...
        return Task.FromResult<SchemaExp?>(
            attr.Type == ArithmeticType.Transform
                ? new TransformArithmeticExp(callExp.Function.MethodInfo, callExp.Args, callExp.SchemaType)
                : new ArithmeticExp(attr.Type, callExp.Args, callExp.SchemaType));
    }
