...
public record ConstantExp(Node.DataNode Value) : SchemaExp(Value.NodeType);
...
public record DefaultExp(SchemaExp Inner, Node.DataNode Default) : SchemaExp(Default.NodeType);
