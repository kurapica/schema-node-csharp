...
[Relation<CascadeDepth, Call>(nameof(Default), $"{NS_SYSTEM_INTRINSIC}.{nameof(SystemIntrinsic.assign)}", $"@{nameof(CascadeDepth)}")]
...
[Relation<CascadeDepth, Call>(nameof(BlackList), $"{NS_SYSTEM_INTRINSIC}.assign", $"@{nameof(CascadeDepth)}")]
...
[Relation<CascadeDepth, Call>(nameof(WhiteList), $"{NS_SYSTEM_INTRINSIC}.{nameof(SystemIntrinsic.assign)}", $"@{nameof(CascadeDepth)}")]
[Relation<Visible, Call>(nameof(Root), $"{NS_SYSTEM_SCHEMA_REFLECT_ENUM}.{nameof(Function.Reflect.Enum.hascascade)}", TYPE_PROVIDER)]
[Relation<InVisible, Call>(nameof(Root), $"{NS_SYSTEM_LOGIC}.{nameof(SystemLogic.le)}", $"@{nameof(CascadeDepth)}", 1L)]
...
[Relation<CascadeDepth, Call>(nameof(Root), $"{NS_SYSTEM_SCHEMA_REFLECT_ENUM}.{nameof(Function.Reflect.Enum.getcascade)}", TYPE_PROVIDER, $"@{nameof(CascadeDepth)}", -1L)]
[Relation<EntrySource, Assign>(nameof(CascadeDepth), $"{NS_SYSTEM_SCHEMA_REFLECT_ENUM}.{nameof(Function.Reflect.Enum.getcascades)}", TYPE_PROVIDER)]
