...
[Relation<Visible, Relation.Call>(nameof(LeafOnly), $"{NS_SYSTEM_SCHEMA_REFLECT_ENUM}.{nameof(SchemaNode.Function.Reflect.Enum.hascascade)}", $"@{nameof(StructFieldSchema.Type)}")]
