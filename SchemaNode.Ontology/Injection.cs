...
/// </summary>
public static class SchemaNodeAIInjection
{
    /// <summary>
    /// Registers the SchemaNode.AI assembly for API discovery, configures
    ...
    /// <para>
    /// <b>Must be called before <c>AddSchemaNode</c></b> so that the AI APIs
    ...
    public static IServiceCollection AddSchemaNodeAI(
