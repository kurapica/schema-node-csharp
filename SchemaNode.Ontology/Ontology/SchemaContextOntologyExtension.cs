...
public static class SchemaContextOntologyExtension
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // â”€â”€ Fields: each field = one DB table â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if (app.Fields is { Count: > 0 })
        {
            foreach (AppFieldType field in app.Fields)
            {
                ...
                // Unwrap array â†?get element type
        ...
        // â”€â”€ Relation annotations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        {
            // SubAppList not yet populated ¡ª load each sub-app individually
    ...
    /// Mapping rules:
    /// <list type="bullet">
    ///   <item><b>SystemLevel</b> ¡ª no relation (data is global).</item>
    ///   <item><b>BusinessTarget</b> ¡ª Composition: one <c>owl:FunctionalProperty</c> pair
    ///     pointing to <c>app:TargetEntity</c>, <c>rdfs:subPropertyOf schema:isPartOf</c>.</item>
    ///   <item><b>IsolationContext (1 map)</b> ¡ª Aggregation: one ObjectProperty pair,
    ///     <c>rdfs:subPropertyOf schema:isPartOf</c>, <c>owl:minCardinality 1</c>.</item>
    ///   <item><b>IsolationContext (N maps)</b> ¡ª Association: one ObjectProperty pair per axis,
    ...
    /// Uses <c>SchemeType</c> â€?already resolved during <c>StructType.LoadAsync</c>.
    /// </summary>
        ...
        HashSet<string> visitedEnums)
    {
        ...
        foreach (StructFieldSchema field in structType.Fields)
        {
            ...
            switch (fieldType)
            {
                ...
                case EnumType et:
                    // SKOS Concepts are OWL individuals ¡ú owl:ObjectProperty
                    rangeIri = BuildEnumClass(graph, et, visitedEnums);
                    kind     = OntologyPropertyKind.Object;
                    break;
