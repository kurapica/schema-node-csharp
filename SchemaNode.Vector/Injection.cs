...
namespace SchemaNode.Vector;

/// <summary>
/// Dependency-injection extensions for <c>SchemaNode.Vector</c>.
/// </summary>
public static class SchemaNodeVectorInjection
{
    /// <summary>
    /// Registers the SchemaNode.Vector assembly for API discovery, configures
